...
t comprehensions <https://book.pythontips.com/en/latest/comprehensions.html>`__ should be second nature for you by now. Just in case, these are nothing more than a compact way to write ``for`` loops and store the result in a list. The above code can also be written like this:
