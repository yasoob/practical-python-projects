...
`` stands for ``get_frame``. It grabs the frame of the video (picture is a static video in our case) at a specific time ``t``. We then return a chunk of the frame we want visible on the screen at that time.
